...
const nl: Dict = {
  ...
  'settings.sources': 'Bronnen',
  'settings.noSources': 'Nog geen bron toegevoegd.',
  'settings.sourceAdd': 'Bron toevoegen',
  'settings.sourceEdit': 'Bron bewerken',
  'settings.sourceRemove': 'Bron verwijderen',
  'settings.sourceRemoveConfirm': '"{name}" verwijderen?',
  'settings.mergeSources': 'Bronnen samenvoegen',
  'settings.mergeSourcesHint':
    'Toon alle bronnen als één bibliotheek. Dezelfde zender uit meerdere bronnen wordt samengevoegd; je ziet en kiest de herkomst in het detail.',
...
const en: Dict = {
  ...
  'settings.noSources': 'No source added yet.',
  'settings.sourceAdd': 'Add source',
  'settings.sourceEdit': 'Edit source',
  'settings.sourceRemove': 'Remove source',
  'settings.sourceRemoveConfirm': 'Remove "{name}"?',
  'settings.mergeSources': 'Merge sources',
  'settings.mergeSourcesHint':
    'Show all sources as one library. The same channel from multiple sources is merged; you see and pick the origin in the detail view.',
